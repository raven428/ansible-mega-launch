...
def main():
  ...
  if not os.path.exists(log_path):
    module.fail_json(
      msg="could not find job", ansible_job_id=jid, started=True, finished=True
    )
  ...
  try:
    ...
    if not data:
      ...
      module.exit_json(
        results_file=log_path, ansible_job_id=jid, started=True, finished=False
      )
    else:
      module.fail_json(
        ansible_job_id=jid,
